...
public class Quadrilateral extends Figure {
    ...
    public Quadrilateral(Point a, Point b, Point c, Point d) {
        ...
        a1 = a.getY() - c.getY();
        b1 = c.getX() - a.getX();
        c1 = a.getX() * c.getY() - c.getX() * a.getY();
        a2 = b.getY() - d.getY();
        b2 = d.getX() - b.getX();
        c2 = b.getX() * d.getY() - d.getX() * b.getY();
        double det = a1 * b2 - a2 * b1;
        double x = (b1 * c2 - b2 * c1) / det;
        double y = (a2 * c1 - a1 * c2) / det;
        if (x!=)
//        if (firstAreaTriangle == 0 | secondAreaTriangle == 0) {
//            throw new IllegalArgumentException("Triangle is degenerative");
        }
    }
    ...
    public Point centroid() {
        ...
        Point triangle2 = new Point(x2, y2);
    ...
    public boolean isTheSame(Figure figure) {
        if (figure instanceof Quadrilateral) {
            ...
            double sideAC1 = ((Quadrilateral) figure).getA().distanceTo(((Quadrilateral) figure).getC());
